...
SEED_PRODUCTS = [
    ...
    (
        ...
        79.99,
        "Clothing",
        "https://images.unsplash.com/photo-1513378628213-b8f36d8c2878?w=400&h=400&fit=crop",
        True,
        4.5,
    ),
    (
    ...
    (
        ...
        44.99,
        "Clothing",
        "https://images.unsplash.com/photo-1556812191-381c7e7d96d6?w=400&h=400&fit=crop",
        True,
        3.5,
    ),
    (
    ...
    (
        ...
        27.99,
        "Home",
        "https://images.unsplash.com/photo-1602607202436-d1b8db3b7b32?w=400&h=400&fit=crop",
        True,
        4.7,
    ),
    (
    ...
    (
        ...
        149.99,
        "Clothing",
        "https://images.unsplash.com/photo-1611308724917-d69270e94482?w=400&h=400&fit=crop",
        True,
        4.7,
    ),
    (
    ...
    (
        ...
        12.99,
        "Home",
        "https://images.unsplash.com/photo-1575833949203-ade5a03eb82c?w=400&h=400&fit=crop",
        True,
        2.6,
    ),
    (
    ...
    (
        ...
        44.99,
        "Sports",
        "https://images.unsplash.com/photo-1592999641298-434e28c11d14?w=400&h=400&fit=crop",
        True,
        4.8,
    ),
    (
