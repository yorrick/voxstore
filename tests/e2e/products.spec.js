...
test.describe('Product Browsing', () => {
  test('loads product grid on homepage', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/screenshots/product-grid-loaded.png', fullPage: true });
  });
  ...
  test('filters by category', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/screenshots/filtered-electronics.png', fullPage: true });
  });
